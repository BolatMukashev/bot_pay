...
button_next = InlineKeyboardButton(text='Далее ➡️', callback_data=next_penalty.new(type='lty', position=2))
...
button_back = InlineKeyboardButton(text='⬅️ Назад', callback_data=next_penalty.new(type='lty', position=1))
button_void = InlineKeyboardButton(text='⠀', callback_data=next_penalty.new(type='lty', position=9))
button_next = InlineKeyboardButton(text='Далее ➡️', callback_data=next_penalty.new(type='lty', position=3))
...
button_back = InlineKeyboardButton(text='⬅️ Назад', callback_data=next_penalty.new(type='lty', position=2))
button_void = InlineKeyboardButton(text='⠀', callback_data=next_penalty.new(type='lty', position=9))
button_next = InlineKeyboardButton(text='Далее ➡️', callback_data=next_penalty.new(type='lty', position=4))
...
button_back = InlineKeyboardButton(text='⬅️ Назад', callback_data=next_penalty.new(type='lty', position=3))
button_void = InlineKeyboardButton(text='⠀', callback_data=next_penalty.new(type='lty', position=9))
button_next = InlineKeyboardButton(text='Далее ➡️', callback_data=next_penalty.new(type='lty', position=5))
...
button_back = InlineKeyboardButton(text='⬅️ Назад', callback_data=next_penalty.new(type='lty', position=4))
button_void = InlineKeyboardButton(text='⠀', callback_data=next_penalty.new(type='lty', position=9))
