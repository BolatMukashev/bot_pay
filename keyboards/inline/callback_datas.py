...
referral_button_call = CallbackData('ref', 'referral', 'value')
question_button_call = CallbackData('quest', 'question', 'value')
pay_button_call = CallbackData('pay', 'pay_button', 'value')
