...
GIFT_CERTIFICATE = {
    'start_text_RU': 'Не знаешь что подарить на праздник или день рождения?\n'
                     'Хочешь порадовать дорого тебе человека?\n'
                     'У нас есть решение - Подарочный сертификат!\n'
                     'Сертификат предоставляет безграничный доступ к нашему сервису (тариф Премиум Max)',
    'get_id_RU': 'Перешли сюда любое сообщение от того человека, которому хочешь подарить сертификат ⤵️',
    'get_name_RU': 'Что впишем в поле "Имя"? ⤵️\n'
                   '(пример: просто имя, ФИО, ласковое прозвище и т.д.)',
    'get_text_RU': 'Напиши короткое сообщение/пожелание этому человеку ⤵️',
    'get_sender_name_RU': 'Как подписать Вас?\n'
                          '(пример: любимый муж/жена, Ваше имя, от коллектива и т.д.)',
    'get_pay_RU': 'Почти готово. Осталось только оплатить\n'
                  'Для Вас это будет стоить всего (tariff["premium_max"] / event(2) / tariff["premium_max"](2)',
    ...
    'start_text_KZ': 'Мереке немесе туған күн үшін не сыйлайтыныңызды білмейсіз бе?\n'
                     'Өзіңізге қымбат жанды қуантқыңыз келе ме?\n'
                     'Бізде шешім бар - сыйлық сертификаты!\n'
                     'Сертификат біздің қызметімізге шексіз қол жеткізуді қамтамасыз етеді (Premium Max тарифі)',
    'get_id_KZ': 'Сертификат бергіңіз келетін адамның кез келген хабарламасы осында жібер ⤵️',
...
IMAGES = {
    ...
    'tariffs_RU_RU_event': 'AgACAgIAAxkBAAKQvGGfWTbj-pIUTRnQV-2yb5uQugtTAAKIuDEblykBSS1CtdUU35KRAQADAgADcwADIgQ',
    'tariffs_RU_KZ_event': 'AgACAgIAAxkBAAKQvGGfWTbj-pIUTRnQV-2yb5uQugtTAAKIuDEblykBSS1CtdUU35KRAQADAgADcwADIgQ',
    'tariffs_KZ_RU_event': 'AgACAgIAAxkBAAKQvmGfWV1keXV8nKSOLyck8jgisCrkAAKJuDEblykBScDhxh6RAfxhAQADAgADcwADIgQ',
    'tariffs_KZ_KZ_event': 'AgACAgIAAxkBAAKQwGGfWZcnk4hCZu6Jj7AQ6Th1id9_AAKKuDEblykBSdxPSbae_M6tAQADAgADcwADIgQ',
...
TEST_IMAGES = {
    ...
    'tariffs_RU_RU_event': 'AgACAgIAAxkBAAIeKWGfWcroQ04av9G0ZTr-t8JQR9R1AAKIuDEblykBSdA_24V7YIhRAQADAgADcwADIgQ',
    'tariffs_RU_KZ_event': 'AgACAgIAAxkBAAIeKWGfWcroQ04av9G0ZTr-t8JQR9R1AAKIuDEblykBSdA_24V7YIhRAQADAgADcwADIgQ',
    'tariffs_KZ_RU_event': 'AgACAgIAAxkBAAIeK2GfWenokF6uVqUShjcXrxWaUmR-AAKJuDEblykBSUbPQI0TNazeAQADAgADcwADIgQ',
    'tariffs_KZ_KZ_event': 'AgACAgIAAxkBAAIeLWGfWfm2dRd9eoI7kD35u9UOaz-5AAKKuDEblykBSRtBfLJ-ZNasAQADAgADcwADIgQ',
