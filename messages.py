MESSAGE = {
    ...
    'limit_error_RU': 'Просим прощения, но Ваш пробный период закончился.\n'
                      ...
                      'Чтобы произвести оплату нажмите на /pay\n'
                      'Для активации ПРОМОКОДА нажмите на /promo_code\n\n'
...
PROMOTIONS = {
    ...
    '100friends_action_message1_RU': 'Вот твоя ссылка! Отправляй её друзьям:',
    '100friends_action_message2_RU': 'Бот для обучения ПДД',
    '100friends_action_message1_KZ': 'Міне сілтеме! Достарыңызға жіберіңіз:',
    '100friends_action_message2_KZ': 'Жол ережелерін үйретуге арналған бот',
}
