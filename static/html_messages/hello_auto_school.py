def hello_auto_school_message(secret_key):
    ...
    <body>
        <div class="main__block">
            ...
            <div><a href="http://pddgoodbot.ru"><button class="button">Активировать Промокод</button></a></div>
            <h3>Что даёт ПРОМОКОД?</h3>
            <p>Дополнительные <b>7 дней</b> доступа к нашей Образовательной платформе для <b>ВСЕХ</b>,<br>
